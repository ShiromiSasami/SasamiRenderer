// VulkanGraphicsDeviceCommandEncoder.cpp
// VulkanRhiCommandEncoder implementation, plus VulkanGraphicsDevice initialize/getter methods.
...
namespace SasamiRenderer
{
    ...
    bool VulkanGraphicsDevice::Initialize(HWND hWnd, UINT width, UINT height, UINT bufferCount)
    {
        ...
        if (!CreateInstance() ||
            ...
            !CreateFrameResources(static_cast<UINT>(m_swapchainImages.size()))) {
            Cleanup();
            return false;
        }
