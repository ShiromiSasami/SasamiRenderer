// GpuSoftwareRayTracerReSTIR.cpp
...
namespace SasamiRenderer
{
                                                        ...
                                                        RayTracingRuntimeStats& outStats)
    {
        ...
        // =========================================================================
        {
            ...
            DebugIncrementDispatchCount();
            {
                ...
                snprintf(buf, sizeof(buf),
                    "[DispatchDiag] idx=%u pass=ReSTIR_Initial lightBufValid=%d lightVA=0x%llX\n",
                    DebugGetDispatchCount(), m_lightDataBuffer.IsValid() ? 1 : 0,
                    (unsigned long long)ptLightsVA);
                DebugLog(buf);
            }
#endif
        ...
        // =========================================================================
        {
            ...
            DebugIncrementDispatchCount();
            {
                char buf[256];
                snprintf(buf, sizeof(buf),
                    "[DispatchDiag] idx=%u pass=ReSTIR_Shade lightBufValid=%d lightVA=0x%llX\n",
                    DebugGetDispatchCount(), m_lightDataBuffer.IsValid() ? 1 : 0,
                    (unsigned long long)ptLightsVA);
                DebugLog(buf);
            }
                                                   ...
                                                   RayTracingRuntimeStats& outStats)
    {
        ...
        DebugIncrementDispatchCount();
        {
            char buf[256];
            snprintf(buf, sizeof(buf),
                "[DispatchDiag] idx=%u pass=ReSTIR_Shadow lightBufValid=%d lightVA=0x%llX\n",
                DebugGetDispatchCount(), m_lightDataBuffer.IsValid() ? 1 : 0,
                (unsigned long long)ptLightsVA);
            DebugLog(buf);
        }
