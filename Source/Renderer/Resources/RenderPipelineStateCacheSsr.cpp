...
namespace SasamiRenderer
{
                                                                          ...
                                                                          const std::string& computeProfile)
    {
        ...
        // Matches IblSystem::PublishIblSrvs layout: [0]=irradiance, [1]=prefilter, [2]=BRDF LUT.
        D3D12_DESCRIPTOR_RANGE iblRange{
            D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 3, 4, 0, D3D12_DESCRIPTOR_RANGE_OFFSET_APPEND
        };
        ...
        params[6].DescriptorTable.pDescriptorRanges = &iblRange;
        ...
        if (!LoadShaderBlob(m_shaderBlobCache,
                            L"Effects/Reflections/SSR/ScreenSpaceReflection_CS.hlsl",
                            "CSMain",
