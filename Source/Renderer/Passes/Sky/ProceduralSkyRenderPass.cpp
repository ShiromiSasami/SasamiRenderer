...
namespace SasamiRenderer
{
    ...
    void ProceduralSkyRenderPass::BuildRequirements(RenderPassRequirementBuilder& builder) const
    {
    ...
    void ProceduralSkyRenderPass::Setup(RenderGraphBuilder& builder) const
    {
    ...
    bool ProceduralSkyRenderPass::Execute(const RenderPassContextView& context) const
    {
        if (!context.IsSatisfied()) {
            DebugLog("ProceduralSkyRenderPass::Execute: runtime context is invalid.\n");
            return false;
        }
        ...
        if (!skybox.IsSkyboxVBValid()) {
            DebugLog("ProceduralSkyRenderPass::Execute: skybox vertex buffer not ready.\n");
            return false;
        }
        ...
        // Bind IBL SRV table as a dummy at slot 0  EProceduralSky_PS.hlsl does not declare t0
