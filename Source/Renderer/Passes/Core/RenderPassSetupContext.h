...
namespace SasamiRenderer
{
    ...
    struct RenderPassExecutionPolicy
    {
        ...
        bool useScreenSpaceReflections = false;
        bool vsmBlurEnabled = true;
        float reflectionMode = 0.0f; // 0=disabled, 1=SWRT; SSR is generated by a separate pass
        float ssrMaxDistance = 28.0f;
        float ssrThickness = 0.18f;
        float ssrStepCount = 48.0f;
        float ssrRoughnessCutoff = 0.78f;
        float ssrRefineSteps = 4.0f;
        float ssrEdgeFade = 0.075f;
        float ssrNormalOffset = 0.02f;
    ...
    struct RenderPassLightingData {
        ...
        GpuDescriptorHandle iblSpecularSrvTable{};
    ...
    struct RenderPassSsrData {
        ID3D12Resource* sceneColorResource = nullptr;
        ID3D12Resource* sceneColorCopyResource = nullptr;
        ID3D12Resource* reflectionResource = nullptr;
        CpuDescriptorHandle sceneColorRtv{};
        GpuDescriptorHandle sceneColorCopySrv{};
        GpuDescriptorHandle reflectionSrv{};
        GpuDescriptorHandle reflectionUav{};
    };
